...
const Cancel = () => {
  return (
    <div className="flex flex-col items-center justify-center py-36 bg-[#0B0B0B] px-4">
      ...
      <Link
        to="/courses"
        className="px-4 py-2 block w-full rounded-full border border-red-600 text-sm font-medium text-white hover:text-black hover:bg-red-600 focus:outline-none focus:ring sm:w-auto text-center"
      >
        Buy A Course?
      </Link>
