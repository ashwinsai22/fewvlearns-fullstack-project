    ...
    <footer className="mx-auto py-14 flex justify-center items-center bg-black">
      <div className="mx-auto">
        ...
        <div className="flex space-x-10 justify-center items-center mb-14">
          <Link to="https://x.com/" className="block text-gray-200 transition-all duration-500 hover:text-red-600">
...
<Link to="https://www.instagram.com/" className="block text-gray-200 transition-all duration-500 hover:text-red-600">
  <svg
  ...
  >
    ...
    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" />
          ...
          <Link to="https://www.facebook.com/" className="block text-gray-200 transition-all duration-500 hover:text-red-600">
          ...
          <Link to="https://www.youtube.com/" className="block text-gray-200 transition-all duration-500 hover:text-red-600">
        ...
        <span className="text-lg text-red-600 text-center block">
          ©<Link to="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="hover:text-red-500">Bezawada Academy</Link> 2025. All rights reserved.
        </span>
      </div>
    </footer>
  );
